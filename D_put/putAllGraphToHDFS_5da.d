...
targetday=`date -d '5 day ago' '+%Y%m%d'`
...
hdfs dfs -put T=4/_story/vocedgelist-4.${targetday}.json log-graph/daily/all/vocedgelist-4.${targetday}.json
#hdfs dfs -copyToLocal /user/rcosloguser02/logs/log-${targetday}.rcoslog000[123].log ./
